...
def setup_params(params):
    ...
    n_sigma = 4
    B_x_max = params.mu_B_x + n_sigma*params.sigma_B_x
    M_x_eff_max = esdr_floquet_lib.get_M_x_eff(params.D_GS, params.M_x, B_x_max, params.B_y)
    D_GS_eff_max = esdr_floquet_lib.get_D_GS_eff(params.D_GS, params.M_x, B_x_max, params.B_y)
